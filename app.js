...
const outcomeConfig = {
  emotional_exhaustion: {
    ...
    cta: "Посмотреть направления для мягкого перехода",
    secondary: "Обсудить безопасный следующий шаг с консультантом",
  ...
  growth_ceiling: {
    ...
    cta: "Посмотреть направления для роста",
  ...
  wrong_place: {
    ...
    cta: "Перейти к примерке профессий",
    secondary: "Записаться на консультацию",
  ...
  money_freedom: {
    ...
    cta: "Посмотреть направления для роста дохода и свободы",
    secondary: "Пройти примерку профессии",
  ...
  soft_search: {
    ...
    cta: "Посмотреть направления для мягкого старта",
    secondary: "Пройти примерку профессии",
...
const offers = {
  emotional_exhaustion: {
    ...
    primaryCta: "Получить стартовый бонус",
  },
  growth_ceiling: {
...
const finalCtas = {
  emotional_exhaustion: {
    primary: "Посмотреть направления для мягкого перехода",
    secondary: "Обсудить безопасный шаг с консультантом",
  },
  growth_ceiling: {
    primary: "Посмотреть направления для роста",
    secondary: "Обсудить карьерный апгрейд с консультантом",
  },
  wrong_place: {
    primary: "Пройти примерку профессии",
    secondary: "Обсудить направления с профориентологом",
  },
  money_freedom: {
    primary: "Посмотреть направления для дохода и свободы",
    secondary: "Получить консультацию по выбору",
  },
  soft_search: {
    primary: "Посмотреть направления для мягкого старта",
    secondary: "Пройти примерку направления",
  },
};
